...
func (c *adapterCapture) Authenticate(_ context.Context, h http.Header) (Caller, error) {
	c.calls++
	c.headers = h
	return Caller{Source: SourceAccessToken, Service: "adapter", Namespace: "stack"}, nil
}
func TestAdapterBearerBoundary(t *testing.T) {
