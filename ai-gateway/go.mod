...
require (
	...
	github.com/grafana/ai-sdk v0.1.0-alpha.1.0.20260906154134-2246be05299b
	github.com/grafana/ai-sdk/providers/anthropic v0.0.0-20260906154134-2246be05299b
