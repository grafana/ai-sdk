...
- [x] 1.5 Add table-driven strict-decoding tests for required fields, typed nulls, unknown discriminators, malformed active fields, additive fields, inactive sibling-arm fields, qualified identifiers, provider options, and top-level or nested reserved gateway namespaces.
...
- [x] 3.1 Implement field-by-field message and content conversion with the canonical role/content matrix, system-string handling, required active-arm fields, privacy rejection, and additive-field tolerance.
