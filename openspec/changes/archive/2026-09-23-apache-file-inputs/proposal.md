...
- Update the independent Go Gateway client and reusable Agent Observability/logger; add deterministic cross-language/UI evidence. Do not import Gateway production code into Apache modules.
