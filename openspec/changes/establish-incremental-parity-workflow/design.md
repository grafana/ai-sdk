...
**Goals:** separate a pinned-version upgrade/assessment PR from independent parity matching; comprehensively assess current Go behavior rather than only the release delta; register actionable packages with honest coverage; preserve fixed targets, independently green delivery and safe discovery automation.
