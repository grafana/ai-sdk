...
- Support boundary: generated media outputs (WP16), reasoning-file runtime (WP17), and file fallback remain deferred. The existing Bedrock tool-result URL warning/omission deviation remains as documented in `PARITY.md`; no new intentional deviation or stable coverage-map status change was accepted.
