...
Define middleware behavior for applying default language-model call settings while preserving caller overrides and correctly merging provider options and headers.
