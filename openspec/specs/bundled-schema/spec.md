...
The `schema` package provides a `Schema` type that bundles a JSON Schema definition with a pre-compiled validator, serving as the primary schema currency across the module.
