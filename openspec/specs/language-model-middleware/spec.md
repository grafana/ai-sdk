...
Define language-model middleware composition, parameter transformation, generate and stream wrapping, metadata overrides, error propagation, and stream transformation.
