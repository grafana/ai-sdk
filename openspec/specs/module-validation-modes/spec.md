...
Separate explicit Gateway candidate-source integration from standalone published-module validation without weakening the existing SDK-to-Gateway boundary or required gates.
