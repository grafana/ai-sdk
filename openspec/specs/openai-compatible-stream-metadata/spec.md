# openai-compatible-stream-metadata Specification

## Purpose

Define when OpenAI-compatible responses expose meaningful identity and timestamp
metadata rather than provider placeholder values.
