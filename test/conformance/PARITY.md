...
| Tool finish gating: `execute-tools-from-stream{,.test}.ts`, `is-tool-execution-allowed-finish-reason.ts` | Go executes queued calls after completed/partial streams without the target stop/tool-calls gate. Implementation bug [#208](https://github.com/grafana/ai-sdk/issues/208). |
